<template>
  <div class="vue-component-root" :class="{hidden: containerHidden}">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
      <symbol id="i-star" viewBox="0 0 126.73 126.73">
    ...
    export default {
        ...
        methods: {
            ...
            afterVote: function (el) {
                ...
                } else if (afterVoteText[this.currentAssessment.assessment_value] && typeof afterVoteText[this.currentAssessment.assessment_value] === "string"
